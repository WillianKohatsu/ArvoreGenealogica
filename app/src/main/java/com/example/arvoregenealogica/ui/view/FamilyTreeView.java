package com.example.arvoregenealogica.ui.view;
...
import com.example.arvoregenealogica.utils.GlideCircleTransform;

import java.util.ArrayList;
import java.util.List;

/**
 * ViewGroup personalizado da árvore genealógica
 */
...
public class FamilyTreeView extends ViewGroup {
    ...
    private static final float CALL_TEXT_SIZE_SP = 9f;
    private static final float NAME_TEXT_SIZE_SP = 11f;
