...
/**
 * Family member database help class
 */

public class FamilyDBHelper {

    private final String DB_NAME = "FamilyTree.db";
    private final boolean DEBUGGABLE = true; // Whether to output log

    private LiteOrm liteOrm;

    private boolean mInquirySpouse = true;//Whether to query spouse
